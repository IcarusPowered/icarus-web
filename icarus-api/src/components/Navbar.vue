<template>
  <div>
    <div class="navbar">
      ...
      <el-button class="logreg" v-if="isLogin">注册 / 登录</el-button>
...
::v-deep .el-icon-vector {
  background: url('../assets/images/Vector.png') center no-repeat;
  font-size: 23px;
  margin-right: 5px;
}
::v-deep .el-icon-vector:before {
  content: "替";
  font-size: 23px;
  visibility: hidden;
}
